...
class BFSAlgorithm:
    ...
    def __process_level(self, level_states):
        ...
        for state in level_states:
            if atomix2.verify_solution(self._solution, state[1]):
                ret.append(state)
        ...
        for state in level_states:
            next_level.append(atomix2.move_up(state[1], state[0]))
            next_level.append(atomix2.move_down(state[1], state[0]))
            next_level.append(atomix2.move_left(state[1], state[0]))
            next_level.append(atomix2.move_right(state[1], state[0]))
